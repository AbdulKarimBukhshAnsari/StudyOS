...
/** Shared skeleton for semester detail (subjects): route loading + client isLoading use this so no visual jump. */
export function SemesterDetailSkeleton() {
  const breadcrumbs: BreadcrumbItem[] = [
    { id: 'semesters', label: 'Semesters', href: ROUTES.private.dashboardSemester },
